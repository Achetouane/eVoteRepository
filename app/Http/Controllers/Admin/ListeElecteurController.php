...
class ListeElecteurController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.liste_electeur.index', compact('votes', 'candidats')); 
    }
    ...
    public function edit(Request $request)
    {
       ...
       //dd($users->votes);
        ...
        return view('admin.liste_electeur.edit', compact('vote','votes', 'candidats')); 
    }
