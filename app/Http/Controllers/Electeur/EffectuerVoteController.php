...
class EffectuerVoteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('electeur.effectuer_vote.index', compact('votes', 'candidats')); 
    }
    ...
    public function edit(Request $request)
    {
       ...
       // dd(session()->get('currentVoteId'));
        ...
        return view('electeur.effectuer_vote.edit', compact('vote','votes', 'candidats','users', 'index', 'candidat')); 
    }
    ...
    // ]);
        ...
        return view('electeur.effectuer_vote.edit', compact('votes', 'candidats', 'vote','index','users','candidat')); 
    }
