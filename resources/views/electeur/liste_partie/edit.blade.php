...
@section('mycontent')
    ...
    <div class="container">
        ...
        <form action="{{ route('electeur.liste_partie.edit') }}" method="post" >
            @csrf
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover  text-center">
                    ...
                    <tbody>
                        ...
                        @foreach ($vote->candidats->unique('partie_id') as $candidat)
                            <tr>
                                <td><img src="{{ asset($candidat->partie->image) }}" alt="" width="110"  height="110"></td>
                                <td>{{  $candidat->partie->name }}</td>
                                <td>{!!  $candidat->partie->description !!}</td> 
                            </tr>                  
                        @endforeach  
