            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <p>Vous êtes candidat ?</p>

                        <div>
                            <input type="radio" id="role" name="role" value="candidat">
                            <label for="role">OUI</label>
                          </div>
                          
                          <div>
                            <input type="radio" id="role1" name="role" value="user">
                            <label for="role1">NON</label>
                          </div>

                          <div class=text-danger>{{ $errors->first('role', ":message") }}</div><br>
